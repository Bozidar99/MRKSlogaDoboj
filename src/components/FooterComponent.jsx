...
function FooterComponent() {
  ...
  return (
    <footer className="relative text-gray-300 bg-[#0b0f19]">
      ...
      {/* SPONZORI BAR — na mobilnom 2x2 raspored (1 2 / 3 4), na vecim ekranima u jednom redu */}
      <div className="border-t border-gray-800 py-6">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-2 sm:flex sm:flex-wrap sm:justify-center items-center gap-6 place-items-center">
          <img src={bht} alt='sponzor' className="w-28 md:w-35 h-16 md:h-20 object-contain hover:scale-110 transition duration-300"/>
          <img src={ers} alt='sponzor' className="w-28 md:w-35 h-16 md:h-20 object-contain hover:scale-110 transition duration-300"/>
          <img src={ter} alt='sponzor' className="w-28 md:w-35 h-16 md:h-20 object-contain hover:scale-110 transition duration-300"/>
          <img src={hero} alt='sponzor' className="w-28 md:w-35 h-16 md:h-20 object-contain hover:scale-110 transition duration-300"/>
        </div>
      </div>
